...
public class DoctorController extends HttpServlet {
    ...
    private void listarDoc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       DoctorDAO doctorDAO = new DoctorDAO();
        ArrayList<Doctor> doctores = doctorDAO.listar();
        request.getSession().setAttribute("listaDoc", doctores);
        request.getRequestDispatcher("WEB-INF/mdoctor/list.jsp").forward(request, response);    
    }
